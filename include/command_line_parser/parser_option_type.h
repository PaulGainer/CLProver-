/*==============================================================================
	...
	An enumeration of the different FileParser options.

	File			: parser_option_type.h
	Author			: Paul Gainer
	Created			: 20/08/2014
...
\==============================================================================/
<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>*/
#ifndef PARSER_OPTION_TYPE_H_
#define PARSER_OPTION_TYPE_H_

enum ParserOptionType
{
	SET_BOOL, SET_INT, SET_INT_WITH_RANGE, SET_STRING
};

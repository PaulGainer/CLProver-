...
public:
	...
	--------------------------------------------------------------------------*/
	CommandLineParser(const std::string&, const std::string&, const bool,
		int, char**);
	...
	--------------------------------------------------------------------------*/
	void addBoolOption(const std::string&, const std::string&, const bool, bool*);
	...
	--------------------------------------------------------------------------*/
	void addIntOption(const std::string&, const std::string&, const bool, int*,
		const std::string&);
	...
	--------------------------------------------------------------------------*/
	void addIntRangeOption(const std::string&, const std::string&, const bool,
	...
	--------------------------------------------------------------------------*/
	void addStringOption(const std::string&, const std::string&, const bool,
